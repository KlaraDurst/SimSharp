...
namespace SimSharp.Visualization {
  class EllipseAnimation : Animation {
    ...
    public EllipseAnimation(Ellipse ellipse0, Ellipse ellipse1, DateTime time0, DateTime time1, string fillColor, string lineColor, int lineWidth, bool keep)
      : base(ellipse0, ellipse1, time0, time1, fillColor, lineColor, lineWidth, keep) { }
